...
export default function ConsentEditor(props: ConsentEditorProps) {
    ...
    return <div className="flex flex-col w-full p-3 bg-backgroundColor2">
        <div className="w-full bg-buttonColor1 text-fontColor0 text-center text-h6 rounded-lg px-5 py-2 mb-2">
        ...
        <div className="w-full flex flex-row justify-end items-end">
            ...
            <div className="w-full text-fontColor1 text-h6 ml-1">YES, continue</div>
        </div>
    </div>;
}
