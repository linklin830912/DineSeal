...
export default function MemoryLaneContent() { 
    ...
    const [fetchRestaurantThemeSettings, {data: restaurantThemeSettings}] = useLazyQuery(GET_RESTAURANT_THEME_SETTINGS_BY_RESTAURANT_ID);
    ...
    return (
        <div className='w-full h-[100vh] relative flex flex-row justify-center items-center bg-gradient-to-b from-backgroundColor0 to-backgroundColor1'>
